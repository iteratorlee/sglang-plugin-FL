...
def main():
    ...
    parser.add_argument("--model-path", default="/models/Hy4-preview-W8A8-linear-moe")
    parser.add_argument("--model-kind", choices=["hy4", "glm"], default="hy4")
            ...
            for repeat in range(args.repeats):
                ...
                try:
                    ...
                    run.update(
                        ...
                        continuous_decode=completed >= case.get("minimum_completion_tokens", 16),
